...
public class ApplicationController {
    ...
    public static  void printUpdateType() {
        System.out.println("\u001B[34m" + "\nChoose update TYPE: \n" +"\n"+ "\u001B[32m" + "INPUT " +
                ...
                + "INPUT " + UpdateCommandsEnum.PHONE_NUMBER_UPDATE.ordinal() + " FOR delete PhoneNumber" +"\n"
                + "INPUT " + UpdateCommandsEnum.EMAIL_UPDATE.ordinal() + " FOR update Email" +"\n"+ "INPUT " +
                UpdateCommandsEnum.EMAIL_UPDATE.ordinal() + " FOR delete Email"+ "\n" + "INPUT " +
                UpdateCommandsEnum.COMPANY_NAME_UPDATE.ordinal() + " FOR update company name" + "\u001B[0m"
                +"\n"+ "INPUT " + UpdateCommandsEnum.COMPANY_NAME_UPDATE.ordinal() +
